      ...
      <table className="w-full text-sm border-collapse">
        ...
        <tbody>
          {[
            ...
            ["Snackbar", "✓ Yes", "Pure presentational"],
            ["Input", "✗ Client", "Requires onChange / event handlers"],
            ["Avatar", "✗ Client", "Uses useEffect for pastel colour generation"],
            ["Modal", "✗ Client", "Uses useState for open/close state"],
            ["Tooltip", "✗ Client", "Uses useState for visibility"],
            ["Carousel", "✗ Client", "Uses useState for slide index"],
            ["FileUploader", "✗ Client", "Uses useState + browser File API"],
